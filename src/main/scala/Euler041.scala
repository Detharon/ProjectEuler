object Euler041 extends EulerApp {
  ...
  /** Problem 41: We shall say that an n-digit number is pandigital if it makes use of all the digits 1 to n exactly
    * once. For example, 2143 is a n-digit pandigital and is also prime.
    *
    * What is the largest n-digit pandigital prime that exists?
    *
    * --------------------------------------------------
    *
    * Explanation: We can start from the "987654321" pandigital number and all of its permutations. This way we check
    * all the 9-digital pandigital numbers. Then we generate the 8-digital pandigital number permutations and keep
